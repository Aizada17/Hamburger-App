...
// разделения масштабного кода, далее компонент должен быть подключен
...
// const [состояние, обновитьСосотояние ] = useState(начальноеСостояние)
...
const App = () => {
    ...
    let hamburgerButtons = [
        { text: 'cheese', img: Cheese, price: 40 },
        { text: 'meat', img: Meat, price: 70 },
        { text: 'tomato', img: Tomato, price: 40 },
        { text: 'salad', img: Salad, price: 50 }
    ]
...
// array.map((элементы, index, array) => {})
...
// [states, server calls] --> будет работать каждый,  раз когда переданные значения массив обновляеются